...
%         u_hat = (0.5/sin(th))*[R(6)-R(8);R(7)-R(3);R(2)-R(4)];
        ...
        reps = floor(T/dt);
            ...
            direction = rotz(-pi/2)*[u_hat(1);u_hat(2);0];
        ...
        Rot = eye(3)+u_skew*u_skew*(1-cos(omega*dt))+u_skew*sin(omega*dt);
        ...
        %% whole Move
            ...
            Rot = eye(3)+u_skew*u_skew*(1-cos(th))+u_skew*sin(th);
